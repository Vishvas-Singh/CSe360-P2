...
public class ControllerFirstAdmin {
	...
	*/
	...
	protected static void doSetupAdmin(Stage ps, int r) {
		...
		String usernameError = ModelFirstAdmin.checkForValidUserName(adminUsername);
		if (usernameError.length() > 0) {
			System.err.println(usernameError);
			Alert a = new Alert(AlertType.ERROR);
			a.setTitle("Invalid Username");
			a.setHeaderText("Please correct the Admin Username");
		...
		if (passwordError.length() > 0) {
			...
			a.setHeaderText("Please correct the Admin Password");
